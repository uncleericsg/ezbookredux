...
const premiumServices: ServiceOption[] = [
  ...
  },
  {
    ...
    duration: '1 hour', // Displayed but not used for scheduling
    paddingBefore: 0, // Not used for redirection cards
    paddingAfter: 0, // Not used for redirection cards
  },
  {
    ...
    duration: '1 hour 30 minutes', // Displayed but not used for scheduling
    paddingBefore: 0, // Not used for redirection cards
    paddingAfter: 0, // Not used for redirection cards
  },
  {
        ...
        >
          {premiumServices.map((service) => (
            <motion.div
              ...
              } rounded-lg p-6 cursor-pointer backdrop-blur-sm shadow-lg relative flex flex-col`}
              onClick={() => {
                if (service.id === 'powerjet-chemical') {
                  navigate('/booking/powerjet-chemical-wash?autoFocus=true', {
                    state: {
                      selectedService: service,
                      fromPriceSelection: true
                    }
                  });
                } else if (service.id === 'gas-leakage') {
                  navigate('/booking/gas-check-leak?autoFocus=true', {
                    state: {
                      selectedService: service,
                      fromPriceSelection: true
                    }
